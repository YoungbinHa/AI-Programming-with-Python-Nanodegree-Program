...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("Percetages statistics summery")
    for key in results_stats_dic:
        ...
        #
        if key[0] == 'p':
            print("{} : {} %".format(" ".join(key.split("_")), results_stats_dic[key]))
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            ...
            if sum(results_dic[key][3:]) == 1:
                print("Real: {:>20}   Classifier: {:>20}".format(results_dic[key][0], results_dic[key][1]))
