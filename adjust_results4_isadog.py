...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as dognames:
        dogname = dognames.readline().rstrip()
        while dogname != "":
    ...
    for key in results_dic:
        ...
        if results_dic[key][0].lower().strip() in dognames_dic:
            pet_label_is_dog = 1
            
        if results_dic[key][1].lower().strip() in dognames_dic:
